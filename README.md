# JS Live Projectional Editor Experiment

This project is an experiment to create a live projectional editor for JavaScript using React/Redux. It currently only has very limited syntax support
